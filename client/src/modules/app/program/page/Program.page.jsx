				...
				<section className="inner-wrapper programs">
							...
							{activePopup === 0 && (
								<div className="popup">
									<div
										...
										style={{ backgroundColor: "#e61453" }}
										onMouseLeave={() => togglePopup(0)}
									>
										<h3> Medialab</h3>
										<p>
											Welkom bij de opening van het onthaal! Hier begint jouw Expo 2025 ervaring.
										</p>
					...
					<div className="program-container">
						...
						<div className="program-title" style={{ backgroundColor: "#C169AA" }}>
							<h3>Eindprojecten derdejaars</h3>
							<img src="/info-icon.svg" alt="" onMouseOver={() => togglePopup(1)} />
							{activePopup === 1 && (
								<div className="popup">
									<div
										className="popup-content"
										style={{ backgroundColor: "#C169AA" }}
										onMouseLeave={() => togglePopup(1)}
									>
										<h3> Medialab</h3>
										<p>
											Loop doorheen de campus om alle eindprojecten van de derde jaars te zien, en
											vote nadien op je favoriete project bij de voting machine.
										</p>
										<span className="close" onClick={togglePopup}>
											&times;
										</span>
						...
						<div className="program-title" style={{ backgroundColor: "#667BC4" }}>
							...
							{activePopup === 3 && (
								<div className="popup">
									<div
										className="popup-content"
										style={{ backgroundColor: "#667BC4" }}
										onMouseLeave={() => togglePopup(3)}
									>
										<h3> Medialab</h3>
										<p>
											Spring in een andere werkelijkheid en hou deze ervaring bij in de vorm van een
											foto.
										</p>
									</div>
									<span className="close" onClick={togglePopup}>
							...
							{activePopup === 4 && (
								<div className="popup">
									...
									>
										<h3> Agora</h3>
										<p>
											Bij deze awardshow worden meerdere prijzen uitgedeeld aan de beste projecten
											van de derdejaars{" "}
										</p>
									</div>
									<span className="close" onClick={togglePopup}>
