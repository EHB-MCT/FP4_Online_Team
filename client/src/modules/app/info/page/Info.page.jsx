		...
		<>
				...
				>
					...
					>
						...
						<p>
							...
							studie in deze richting? Dan is dit de perfecte kans om de sfeer
			...
			<section className={clsx(styles["google-maps-wrapper"], "inner-wrapper")}>
				<div className={clsx(styles["google-maps-wrapper--location-info"])}>
					<div
						className={clsx(
							styles["google-maps-wrapper--location-info--maps-frame"]
						)}
					>
						<iframe
							className="image"
			...
			<section className={clsx(styles["awards-wrapper"], "orange-wrapper")}>
				<div
					className={clsx(
						styles["awards-wrapper--awards-inner-wrapper"],
						"inner-wrapper"
					)}
				>
					<AwardsInfo
						...
						badge={"jury"}
						description={
							"De Juryprijs wordt uitgereikt door onze eigen docenten met hun jaren ervaring en kennis.  Ze zochten naar een duidelijke visie, met veel creativiteit en afwerking. En volgens hen was de keuze niet makkelijk."
						}
					/>
					<AwardsInfo
						...
						badge={"publiek"}
						description={
							"De Publieksprijs werd bepaald door de stemmen van jullie en het publiek.Jullie kregen allemaal de kans om te stemmen op jullie favoriete projecten. Nu gaan we zien welke 3 dat waren"
						}
					/>
					<AwardsInfo
						...
						badge={"innovatie"}
						description={
							" De Innovatieprhijs bekroont het meest vernieuwende technische project. Een project dat niet alleen creatief is, maar ook technisch uitdagend. Waarin grenzen worden verlegd."
						}
					/>
					<AwardsInfo
						...
						badge={"impact"}
						description={
							"Deze gaat naar het project dat de grootste maatschappelijke impact maakt en het meest potentieel heeft om echte veranderingen te maken in de wereld"
						}
					/>
				</div>
			</section>
			...
			<section className={clsx(styles["teaser-video-wrapper"])}>
				<div
					className={clsx(
						styles["teaser-video-wrapper--teaser-video-inner-wrapper"],
				...
				>
					...
					<iframe
						className={clsx(
							styles[
								"teaser-video-wrapper--teaser-video-inner-wrapper--teaser-video"
							]
						)}
			...
			<section className={clsx(styles["course-info-wrapper"], "blue-wrapper")}>
				<div
					className={clsx(
						styles["course-info-wrapper--course-info-inner-wrapper"],
						"inner-wrapper"
					)}
				>
					<div
						className={clsx(
							styles[
								"course-info-wrapper--course-info-inner-wrapper--main-info-wrapper"
							]
						)}
					>
						...
						<NavLink
							to={
								"https://www.erasmushogeschool.be/nl/opleidingen/multimedia-en-creatieve-technologie"
							}
							target="_blank"
							className={"button"}
						>
					...
					<div
						className={clsx(
							styles[
								"course-info-wrapper--course-info-inner-wrapper--image-wrapper"
							]
						)}
					>
